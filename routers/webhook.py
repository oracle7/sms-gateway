...
async def receive_webhook(request: Request, db: Session = Depends(get_db)):
    ...
    try:
        ...
        # This defensively checks for nested structures.
        ...
        # If there's no sender, it might be an outgoing message the app is syncing
        if not raw_number or raw_number == "null":
            raw_number = msg_data.get("recipient", msg_data.get("to", "UNKNOWN"))
            is_inbound = False
